...
public class Scanner {
	...
	static {
		...
		literals.put("OFF", 7);
		literals.put("SET", 8);
		literals.put("COLOR", 9);
		literals.put("DIM", 10);
		literals.put("ARM", 11);
		literals.put("DISARM", 12);
		literals.put("LOCK", 13);
		literals.put("UNLOCK", 14);
		literals.put("OPEN", 15);
		literals.put("CLOSE", 16);
		literals.put("LIGHT", 17);
		literals.put("FAN", 18);
		literals.put("TO", 19);
		literals.put("SPEED", 20);
		literals.put("THERMOSTAT", 21);
		literals.put("MODE", 22);
		literals.put("HEAT", 23);
		literals.put("COOL", 24);
		literals.put("AUTO", 25);
		literals.put("BLINDS", 26);
		literals.put("ALARM", 27);
		literals.put("SYSTEM", 28);
		literals.put("DOOR", 29);
		literals.put("IF", 30);
		literals.put("THEN", 33);
		literals.put("ELSE", 34);
		literals.put("ENDIF", 35);
		literals.put("WHILE", 36);
		literals.put("DO", 37);
		literals.put("ENDWHILE", 38);
		literals.put("FOR", 39);
		literals.put("FROM", 40);
		literals.put("ENDFOR", 41);
		literals.put("VAR", 42);
		literals.put("ROUTINE", 44);
		literals.put("PARAMS", 45);
		literals.put("ENDROUTINE", 47);
		literals.put("WAIT", 48);
		literals.put("SECONDS", 49);
		literals.put("MINUTES", 50);
		literals.put("HOURS", 51);
		literals.put("LOG", 52);
